...
import { getActivities } from "@/lib/api/activities.functions";
...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "IvVah | Activity Feed" },
      {
        name: "description",
        content:
          "Browse small-group activities near you — co-driver runs, chai mates, hackathons, walks, and more.",
      },
    ],
  }),
  component: Feed,
...
export const happeningNow = [
  {
    title: "Chai & Chat at the Square",
    meta: "2 spots left • Ends in 40m",
    img: "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=400&q=70",
  },
  {
    title: "Sun-drenched Pottery Studio",
    meta: "3 spots left • Ends in 1h",
    img: "https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?auto=format&fit=crop&w=400&q=70",
  },
  {
    title: "Park Run + Coffee",
    meta: "1 spot left • Ends in 25m",
    img: "https://images.unsplash.com/photo-1486218119243-13883505764c?auto=format&fit=crop&w=400&q=70",
  },
];
...
export const cards: ActivityCard[] = [
  {
    ...
    blurb:
      "Driving up to Beacon for the gallery openings. Looking for a co-driver to share the tunes and gas.",
  ...
  },
  {
    ...
    blurb:
      "Building a low-fi e-ink notification board. Need someone with some soldering experience.",
    tags: ["MAKER", "WEEKEND"],
    filled: 2,
    total: 4,
  },
  {
    ...
    blurb:
      "Cardamom chai by the water at golden hour. Conversation only — no agenda, no networking.",
  ...
  return (
    <PageShell>
      <div className="mx-auto w-full max-w-7xl px-6 py-8">
        <h1 className="sr-only">IvVah activities near you</h1>
        {/* Hero strip */}
